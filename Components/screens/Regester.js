    ...
    <View style={{ flex: 1}}>
      <View style={{ flex: 1, backgroundColor: '#134c3e' }}>
        ...
        <TouchableOpacity >
         ...
         <TouchableOpacity>
          <Text style={{fontSize:20,marginBottom:40,color:'#fff'}}onPress={()=>navigation.navigate('Firstpage')}>CUSTOMER VIEW</Text>
          </TouchableOpacity>
          <TouchableOpacity>
      ...
      <Appbar.Header style={{ backgroundColor: 'white',justifyContent:'space-between' }}>
        ...
        <Appbar.Action icon="bell-badge-outline" size={30} color={'#134c3e'} onPress={() => {navigation.navigate('Notificationinbox') }} style={{ marginLeft: 10 }} />
      </Appbar.Header>
      <ScrollView>
      <View>
