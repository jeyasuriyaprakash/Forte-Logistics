    ...
    return (
      ...
      <StatusBar backgroundColor="#fff" barStyle="dark-content" />
            ...
            <View style={{ flex: 1, margin: 15 }}>
                <TouchableOpacity  onPress={()=>navigation.navigate('Secandpage')}>
                <Card style={{alignItems:'center',borderRadius:10,padding:20}} >
                    <Card.Cover style={styles.cardImgalin} source={require('../../assets/rate.png')} />
                     <Text style={{fontSize:16,textAlign:'center',color:'#a4745b',marginBottom:10}}  onPress={()=>navigation.navigate('Secandpage')} >ReQuest a Rate Quote</Text>
                     <Paragraph style={{fontSize:13,textAlign:'left'}} >Request a Quickie Quote (minimal information required),or request a Full Quote (more information required).</Paragraph>
                </Card> 
                </TouchableOpacity>  
            </View>
            <View style={{ flex: 1, margin: 15 }}>
                <Card style={{alignItems:'center',borderRadius:10,padding:20}} >
                    <Card.Cover style={styles.cardImgalin} source={require('../../assets/bill.png')} />
                     <Text style={{fontSize:16,textAlign:'center',color:'#a4745b',marginBottom:10}}>Create a Bill of Lading</Text>
                     <Paragraph style={{fontSize:13,textAlign:'left'}}>Create a Bill of Landing that can be printed or downloaded as a PDF.</Paragraph>
                </Card>   
            </View>
            <View style={{ flex: 1, margin: 15 }}>
                <Card style={{alignItems:'center',borderRadius:10,padding:20}} >
                    <Card.Cover style={styles.cardImgalin} source={require('../../assets/template.png')} />
                     <Text style={{fontSize:16,textAlign:'center',color:'#a4745b',marginBottom:10}}>Templates</Text>
                     <Paragraph style={{fontSize:13,textAlign:'left'}}>Templates are re-usable groups of information that can be used to auto-fill certain sections in your forms.</Paragraph>
                </Card>   
            </View>
            <View style={{ flex: 1, margin: 15 }}>
                <Card style={{alignItems:'center',borderRadius:10,padding:20}} >
                    <Card.Cover style={styles.cardImgalin} source={require('../../assets/claim.png')} />
                     <Text style={{fontSize:16,textAlign:'center',color:'#a4745b',marginBottom:10}}>Cargo Claims</Text>
                     <Paragraph style={{fontSize:13,textAlign:'left'}}>Download FedEx and YRC Cargo Claim forms as PDFs. Also contains phone numbers for the FedEx and YRC Cargo Claim Departments.</Paragraph>
                </Card>   
            </View>
            </View>
